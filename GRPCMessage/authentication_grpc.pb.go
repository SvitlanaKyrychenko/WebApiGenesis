...
type AuthenticatorClient interface {
	Authenticate(ctx context.Context, in *AuthenticationUser, opts ...grpc.CallOption) (*AuthenticationResponse, error)
}
...
func (c *authenticatorClient) Authenticate(ctx context.Context, in *AuthenticationUser, opts ...grpc.CallOption) (*AuthenticationResponse, error) {
	out := new(AuthenticationResponse)
	err := c.cc.Invoke(ctx, "/model.Authenticator/Authenticate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthenticatorServer interface {
	Authenticate(context.Context, *AuthenticationUser) (*AuthenticationResponse, error)
...
func (UnimplementedAuthenticatorServer) Authenticate(context.Context, *AuthenticationUser) (*AuthenticationResponse, error) {
...
func _Authenticator_Authenticate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/model.Authenticator/Authenticate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthenticatorServer).Authenticate(ctx, req.(*AuthenticationUser))
	}
...
var Authenticator_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "model.Authenticator",
	...
	Metadata: "model/authentication.proto",
}
