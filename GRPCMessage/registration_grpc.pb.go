...
type RegistrarClient interface {
	Register(ctx context.Context, in *RegistrationUser, opts ...grpc.CallOption) (*RegistrationResponse, error)
}
...
func (c *registrarClient) Register(ctx context.Context, in *RegistrationUser, opts ...grpc.CallOption) (*RegistrationResponse, error) {
	out := new(RegistrationResponse)
	err := c.cc.Invoke(ctx, "/model.Registrar/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RegistrarServer interface {
	Register(context.Context, *RegistrationUser) (*RegistrationResponse, error)
...
func (UnimplementedRegistrarServer) Register(context.Context, *RegistrationUser) (*RegistrationResponse, error) {
...
func _Registrar_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/model.Registrar/Register",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegistrarServer).Register(ctx, req.(*RegistrationUser))
	}
...
var Registrar_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "model/registration.proto",
}
